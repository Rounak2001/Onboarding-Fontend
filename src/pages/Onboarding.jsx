            ...
            <div style={{ minHeight: '100vh', background: '#f9fafb', fontFamily: "'Inter', system-ui, sans-serif" }}>
                ...
                <div style={{ maxWidth: 900, margin: '0 auto', padding: `${isPhoneScreen ? 20 : 32}px ${pageHorizontalPadding}px 60px` }}>
                    <div style={{ marginBottom: 28 }}>
                        <span style={{ display: 'inline-block', fontSize: 16, fontWeight: 600, color: '#059669', background: '#ecfdf5', padding: '4px 12px', borderRadius: 20, marginBottom: 12 }}>Step 1 of 6</span>
